 ...
 */
#ifndef CATAMARI_LDL_SCALAR_LDL_FACTORIZATION_UP_LOOKING_IMPL_H_
#define CATAMARI_LDL_SCALAR_LDL_FACTORIZATION_UP_LOOKING_IMPL_H_
...
template <class Field>
LDLResult Factorization<Field>::UpLooking(const CoordinateMatrix<Field>& matrix)
    CATAMARI_NOEXCEPT {
...
#endif  // ifndef CATAMARI_LDL_SCALAR_LDL_FACTORIZATION_UP_LOOKING_IMPL_H_
